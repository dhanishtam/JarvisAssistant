...
data_path = os.path.join(project_root, 'TTS.html')
print(data_path)
...
class SpeechToTextListener:
    ...
    def __init__(
            self, 
            website_path: str = data_path,
            # website_path: str = r"C:\Users\kobula\Documents\AvgJarvis\voice\TTS.html", 
            language: str = "hi-IN",
            wait_time: int = 10):
